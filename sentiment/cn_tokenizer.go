...
type cnTokenizer struct{}

func NewCNTokenizer() Tokenizer {
	return &cnTokenizer{}
}

func (t *cnTokenizer) Tokenize(text string) (words map[string]int64) {
	words = make(map[string]int64)
	for _, w := range cnsplitTokenRx.Split(text, -1) {
		if len(w) > 0 {
